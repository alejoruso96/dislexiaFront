        ...
        <div className="flex ml-96 text-center mb-5">
          <div className="flex-initial">
            <Card speakCallback={this.props.speakCallback}
                  content={this.state.list[0][0]} Bg="true" />
          </div>
